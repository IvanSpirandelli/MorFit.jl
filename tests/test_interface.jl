...
function test_simplex_count()
    ...
    # n_atoms_per_mol = 3
    # mc_tets = MorFit.Energies.get_multichromatic_tetrahedra(points, n_atoms_per_mol)
    # bcs, filtration = MorFit.Energies.get_barycentric_subdivision_and_filtration(points, n_atoms_per_mol)
