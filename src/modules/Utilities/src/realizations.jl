...
function get_point_vector_realization_per_mol(x::Vector{Tuple{QuatRotation{Float64}, Vector{Float64}}}, template_centers::Matrix{Float64})
    [[Vector{Float64}(e) for e in eachcol(R * template_centers .+ t)] for (R, t) in x]
end
